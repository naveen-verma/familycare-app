...
export default function DisclaimerPage() {
  return (
    <article style={{ color: "var(--color-text-secondary)", lineHeight: 1.7 }}>
      <h1 className="font-medium mb-1" style={{ fontSize: 20, color: "var(--color-text-primary)" }}>Medical Disclaimer</h1>
      <p className="mb-6" style={{ fontSize: 11, color: "var(--color-text-tertiary)" }}>Last updated: April 2026</p>

      <div className="rounded-[8px] px-4 py-3 mb-6" style={{ background: "#FAEEDA" }}>
        <p className="font-semibold mb-1" style={{ fontSize: 12, color: "#854F0B" }}>Important Notice</p>
      ...
      <section>
        <h2 className="font-medium mt-6 mb-2" style={{ fontSize: 14, color: "var(--color-text-primary)" }}>1. Not a Medical Service</h2>
      ...
      <section>
        <h2 className="font-medium mt-6 mb-2" style={{ fontSize: 14, color: "var(--color-text-primary)" }}>2. Always Consult a Doctor</h2>
        <p className="leading-relaxed mb-4" style={{ fontSize: 13 }}>
      ...
      <section>
        <h2 className="font-medium mt-6 mb-2" style={{ fontSize: 14, color: "var(--color-text-primary)" }}>3. Health Records Are User-Provided</h2>
        <p className="leading-relaxed mb-4" style={{ fontSize: 13 }}>
      ...
      <section>
        <h2 className="font-medium mt-6 mb-2" style={{ fontSize: 14, color: "var(--color-text-primary)" }}>4. ICD-10 Condition Tags</h2>
        <p className="leading-relaxed mb-4" style={{ fontSize: 13 }}>
      ...
      <section>
        <h2 className="font-medium mt-6 mb-2" style={{ fontSize: 14, color: "var(--color-text-primary)" }}>5. Medication Information</h2>
        <p className="leading-relaxed mb-4" style={{ fontSize: 13 }}>
      ...
      <section>
        <h2 className="font-medium mt-6 mb-2" style={{ fontSize: 14, color: "var(--color-text-primary)" }}>6. AI-Generated Content (Phase 2)</h2>
        <p className="leading-relaxed mb-4" style={{ fontSize: 13 }}>
      ...
      <section>
        <h2 className="font-medium mt-6 mb-2" style={{ fontSize: 14, color: "var(--color-text-primary)" }}>7. Second Opinion Feature (Phase 2)</h2>
        <p className="leading-relaxed mb-4" style={{ fontSize: 13 }}>
      ...
      <section>
        <h2 className="font-medium mt-6 mb-2" style={{ fontSize: 14, color: "var(--color-text-primary)" }}>8. Shared Medical Summaries</h2>
        <p className="leading-relaxed mb-4" style={{ fontSize: 13 }}>
      ...
      <section>
        <h2 className="font-medium mt-6 mb-2" style={{ fontSize: 14, color: "var(--color-text-primary)" }}>9. No Liability for Medical Outcomes</h2>
        <p className="leading-relaxed mb-4" style={{ fontSize: 13 }}>
      ...
      <section>
        <h2 className="font-medium mt-6 mb-2" style={{ fontSize: 14, color: "var(--color-text-primary)" }}>10. Questions</h2>
        <p className="leading-relaxed mb-4" style={{ fontSize: 13 }}>
